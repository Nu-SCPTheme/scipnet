...
if "compile" in sys.argv:
  print("Compiling deeds directly is considered to be an unstable feature, and I have disabled it until I find a way to do it better.")
  sys.exit(1)
...
import { UserInfo, ExtendedUserInfo } from "./../user/info";
"""]
